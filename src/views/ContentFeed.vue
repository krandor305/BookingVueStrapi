        ...
        return {
          ...
          showDialog:false,
           events: [
                ...
                {status: 'Commentaire', date: '15/10/2020 16:15', icon: 'pi pi-shopping-cart', color: '#FF9800'},
                {status: 'Commentaire Lorem ipsum Lorem ipsum Lorem ipsum', date: '16/10/2020 10:00', icon: 'pi pi-check', color: '#607D8B'}
            ],
